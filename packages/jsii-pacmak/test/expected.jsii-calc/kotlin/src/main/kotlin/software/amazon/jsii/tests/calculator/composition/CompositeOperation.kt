...
abstract class CompositeOperation : software.amazon.jsii.tests.calculator.lib.Operation {
    ...
    abstract val expression: software.amazon.jsii.tests.calculator.lib.Value
     ...
     */
    @get:software.amazon.jsii.Stability(software.amazon.jsii.Stability.Level.Experimental)
    open var stringStyle: software.amazon.jsii.tests.calculator.composition.CompositeOperation.CompositionStringStyle
        get() {
            return this.jsiiGet("stringStyle", software.amazon.jsii.tests.calculator.composition.CompositeOperation.CompositionStringStyle::class.java) ?: error("'stringStyle' should be present")
        }
        set(v) {
    ...
    class `Jsii$Proxy` : software.amazon.jsii.tests.calculator.composition.CompositeOperation {
        /**
         * The value.
         */
        @get:software.amazon.jsii.Stability(software.amazon.jsii.Stability.Level.Experimental)
         ...
         */
        @get:software.amazon.jsii.Stability(software.amazon.jsii.Stability.Level.Experimental)
        override val expression: software.amazon.jsii.tests.calculator.lib.Value
            get() {
         ...
         */
        @get:software.amazon.jsii.Stability(software.amazon.jsii.Stability.Level.Experimental)
        override var stringStyle: software.amazon.jsii.tests.calculator.composition.CompositeOperation.CompositionStringStyle
            get() {
                return this.jsiiGet("stringStyle", software.amazon.jsii.tests.calculator.composition.CompositeOperation.CompositionStringStyle::class.java) ?: error("'stringStyle' should be present")
            }
            set(v) {
