...
open class ObjectRefsInCollections : software.amazon.jsii.JsiiObject {
     ...
     */
    @software.amazon.jsii.Stability(software.amazon.jsii.Stability.Level.Experimental)
    open fun sumFromArray(values: kotlin.collections.List<software.amazon.jsii.tests.calculator.lib.Value>): kotlin.Number {
     ...
     */
    @software.amazon.jsii.Stability(software.amazon.jsii.Stability.Level.Experimental)
    open fun sumFromMap(values: kotlin.collections.Map<kotlin.String, software.amazon.jsii.tests.calculator.lib.Value>): kotlin.Number {
        val args: kotlin.Array<kotlin.Any?> = kotlin.arrayOf(
            values
        )
