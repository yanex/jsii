...
abstract class UnaryOperation : software.amazon.jsii.tests.calculator.lib.Operation {
    constructor(objRef: software.amazon.jsii.JsiiObjectRef) : super(objRef)
    constructor(mode: software.amazon.jsii.JsiiObject.InitializationMode) : super(mode)

    constructor(operand: software.amazon.jsii.tests.calculator.lib.Value) : super(software.amazon.jsii.JsiiObject.InitializationMode.JSII) {
    ...
    open val operand: software.amazon.jsii.tests.calculator.lib.Value
        get() {
            return this.jsiiGet("operand", software.amazon.jsii.tests.calculator.lib.Value::class.java) ?: error("'operand' should be present")
        }

    class `Jsii$Proxy` : software.amazon.jsii.tests.calculator.UnaryOperation {
        /**
         * The value.
         */
        ...
        @get:software.amazon.jsii.Stability(software.amazon.jsii.Stability.Level.Experimental)
        override val operand: software.amazon.jsii.tests.calculator.lib.Value
            get() {
                return this.jsiiGet("operand", software.amazon.jsii.tests.calculator.lib.Value::class.java) ?: error("'operand' should be present")
            }
