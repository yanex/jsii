...
interface NestedStruct : software.amazon.jsii.JsiiSerializable {
    ...
    class Builder {
        ...
        fun build(): software.amazon.jsii.tests.calculator.NestedStruct {
            val numberProp = this.numberProp ?: kotlin.error("Value for property 'numberProp' must be specified")
            return `Jsii$Proxy`(numberProp)
        }
    }

    class `Jsii$Proxy` : software.amazon.jsii.JsiiObject, software.amazon.jsii.tests.calculator.NestedStruct {
        /**
         * When provided, must be > 0.
         */
        @get:software.amazon.jsii.Stability(software.amazon.jsii.Stability.Level.Experimental)
        ...
        override fun equals(other: Any?): Boolean {
            ...
            other as software.amazon.jsii.tests.calculator.NestedStruct
