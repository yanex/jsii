...
interface CalculatorProps : software.amazon.jsii.JsiiSerializable {
    ...
    class Builder {
        ...
        fun build(): software.amazon.jsii.tests.calculator.CalculatorProps {
    ...
    class `Jsii$Proxy` : software.amazon.jsii.JsiiObject, software.amazon.jsii.tests.calculator.CalculatorProps {
        /**
         * The initial value of the calculator.
         * 
         * NOTE: Any number works here, it's fine.
        ...
        override fun equals(other: Any?): Boolean {
            ...
            other as software.amazon.jsii.tests.calculator.CalculatorProps
