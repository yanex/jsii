...
interface StableStruct: software.amazon.jsii.JsiiSerializable {
    ...
    class Builder {
        ...
        fun build(): org.yanex.hello.StableStruct {
    ...
    internal class `Jsii$Proxy`: software.amazon.jsii.JsiiObject, org.yanex.hello.StableStruct {
        @software.amazon.jsii.Stability(software.amazon.jsii.Stability.Level.Stable)
        ...
        override fun equals(other: Any?) {
            ...
            other as org.yanex.hello.StableStruct
