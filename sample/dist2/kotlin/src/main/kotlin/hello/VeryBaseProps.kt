...
interface VeryBaseProps: software.amazon.jsii.JsiiSerializable {
    val foo: org.yanex.hello.IVery

    class Builder {
        var foo: org.yanex.hello.IVery

        fun build(): org.yanex.hello.VeryBaseProps {
            val foo = this.foo ?: kotlin.error("Value for property 'foo' must be specified")
            return `Jsii$Proxy`(foo)
        }
    }

    internal class `Jsii$Proxy`: software.amazon.jsii.JsiiObject, org.yanex.hello.VeryBaseProps {
        ...
        constructor(foo: org.yanex.hello.IVery) : super(software.amazon.jsii.JsiiObject.InitializationMode.JSII) {
            this.foo = foo
        }
        ...
        override fun equals(other: Any?) {
            ...
            other as org.yanex.hello.VeryBaseProps
