...
interface DiamondInheritanceSecondMidLevelStruct : software.amazon.jsii.JsiiSerializable, software.amazon.jsii.tests.calculator.DiamondInheritanceBaseLevelStruct {
    ...
    class Builder {
        ...
        fun build(): software.amazon.jsii.tests.calculator.DiamondInheritanceSecondMidLevelStruct {
    ...
    class `Jsii$Proxy` : software.amazon.jsii.JsiiObject, software.amazon.jsii.tests.calculator.DiamondInheritanceSecondMidLevelStruct {
        @get:software.amazon.jsii.Stability(software.amazon.jsii.Stability.Level.Experimental)
        ...
        override fun equals(other: Any?): Boolean {
            ...
            other as software.amazon.jsii.tests.calculator.DiamondInheritanceSecondMidLevelStruct
