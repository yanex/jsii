...
open class SupportsNiceJavaBuilder : software.amazon.jsii.tests.calculator.SupportsNiceJavaBuilderWithRequiredProps {
    constructor(objRef: software.amazon.jsii.JsiiObjectRef) : super(objRef)
    constructor(mode: software.amazon.jsii.JsiiObject.InitializationMode) : super(mode)

    constructor(id: kotlin.Number, defaultBar: kotlin.Number?, props: software.amazon.jsii.tests.calculator.SupportsNiceJavaBuilderProps?, vararg rest: kotlin.String) : super(software.amazon.jsii.JsiiObject.InitializationMode.JSII) {
