...
open class NumberGenerator : software.amazon.jsii.JsiiObject {
    ...
    constructor(generator: software.amazon.jsii.tests.calculator.IRandomNumberGenerator) : super(software.amazon.jsii.JsiiObject.InitializationMode.JSII) {
    ...
    open var generator: software.amazon.jsii.tests.calculator.IRandomNumberGenerator
        get() {
            return this.jsiiGet("generator", software.amazon.jsii.tests.calculator.IRandomNumberGenerator::class.java) ?: error("'generator' should be present")
        }
        set(v) {
    ...
    @software.amazon.jsii.Stability(software.amazon.jsii.Stability.Level.Experimental)
    open fun isSameGenerator(gen: software.amazon.jsii.tests.calculator.IRandomNumberGenerator): kotlin.Boolean {
        val args: kotlin.Array<kotlin.Any?> = kotlin.arrayOf(
            gen
        )
