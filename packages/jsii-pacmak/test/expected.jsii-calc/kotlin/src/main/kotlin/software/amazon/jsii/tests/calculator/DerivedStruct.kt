...
interface DerivedStruct : software.amazon.jsii.JsiiSerializable, software.amazon.jsii.tests.calculator.lib.MyFirstStruct {
     ...
     */
    @get:software.amazon.jsii.Stability(software.amazon.jsii.Stability.Level.Experimental)
    val nonPrimitive: software.amazon.jsii.tests.calculator.DoubleTrouble

    /**
     * This is optional.
     */
    @get:software.amazon.jsii.Stability(software.amazon.jsii.Stability.Level.Experimental)
    val anotherOptional: kotlin.collections.Map<kotlin.String, software.amazon.jsii.tests.calculator.lib.Value>?
    ...
    class Builder {
         ...
         */
        @get:software.amazon.jsii.Stability(software.amazon.jsii.Stability.Level.Experimental)
        var nonPrimitive: software.amazon.jsii.tests.calculator.DoubleTrouble? = null

        /**
         * This is optional.
         */
        @get:software.amazon.jsii.Stability(software.amazon.jsii.Stability.Level.Experimental)
        var anotherOptional: kotlin.collections.Map<kotlin.String, software.amazon.jsii.tests.calculator.lib.Value>? = null
        ...
        fun build(): software.amazon.jsii.tests.calculator.DerivedStruct {
    ...
    class `Jsii$Proxy` : software.amazon.jsii.JsiiObject, software.amazon.jsii.tests.calculator.DerivedStruct {
        /**
         * An awesome number value.
         */
        @Deprecated("Declaration is deprecated.")
         ...
         */
        @get:software.amazon.jsii.Stability(software.amazon.jsii.Stability.Level.Experimental)
        override val nonPrimitive: software.amazon.jsii.tests.calculator.DoubleTrouble

        /**
         * This is optional.
         */
        @get:software.amazon.jsii.Stability(software.amazon.jsii.Stability.Level.Experimental)
        override val anotherOptional: kotlin.collections.Map<kotlin.String, software.amazon.jsii.tests.calculator.lib.Value>?
        ...
        protected constructor(objRef: software.amazon.jsii.JsiiObjectRef) : super(objRef) {
            ...
            this.nonPrimitive = this.jsiiCall("nonPrimitive", software.amazon.jsii.tests.calculator.DoubleTrouble::class.java) ?: error("'nonPrimitive' should be present")
            this.anotherOptional = this.jsiiCall("anotherOptional", kotlin.collections.Map::class.java) as? kotlin.collections.Map<kotlin.String, software.amazon.jsii.tests.calculator.lib.Value>?
        ...
        constructor(anumber: kotlin.Number, astring: kotlin.String, firstOptional: kotlin.collections.List<kotlin.String>?, anotherRequired: java.time.Instant, bool: kotlin.Boolean, nonPrimitive: software.amazon.jsii.tests.calculator.DoubleTrouble, anotherOptional: kotlin.collections.Map<kotlin.String, software.amazon.jsii.tests.calculator.lib.Value>?, optionalAny: kotlin.Any?, optionalArray: kotlin.collections.List<kotlin.String>?) : super(software.amazon.jsii.JsiiObject.InitializationMode.JSII) {
        ...
        override fun equals(other: Any?): Boolean {
            ...
            other as software.amazon.jsii.tests.calculator.DerivedStruct
