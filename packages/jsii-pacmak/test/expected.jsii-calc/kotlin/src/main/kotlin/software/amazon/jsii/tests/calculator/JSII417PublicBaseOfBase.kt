...
open class JSII417PublicBaseOfBase : software.amazon.jsii.JsiiObject {
    companion object {
        @software.amazon.jsii.Stability(software.amazon.jsii.Stability.Level.Experimental)
        fun makeInstance(): software.amazon.jsii.tests.calculator.JSII417PublicBaseOfBase {
            return software.amazon.jsii.JsiiObject.jsiiStaticCall(software.amazon.jsii.tests.calculator.JSII417PublicBaseOfBase::class.java, "makeInstance", software.amazon.jsii.tests.calculator.JSII417PublicBaseOfBase::class.java) ?: error("Method 'makeInstance()' returned null value")
        }
    }
