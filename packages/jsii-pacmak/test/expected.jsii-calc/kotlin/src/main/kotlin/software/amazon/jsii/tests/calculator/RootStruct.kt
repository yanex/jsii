...
interface RootStruct : software.amazon.jsii.JsiiSerializable {
    ...
    @get:software.amazon.jsii.Stability(software.amazon.jsii.Stability.Level.Experimental)
    val nestedStruct: software.amazon.jsii.tests.calculator.NestedStruct?
    ...
    class Builder {
        ...
        @get:software.amazon.jsii.Stability(software.amazon.jsii.Stability.Level.Experimental)
        var nestedStruct: software.amazon.jsii.tests.calculator.NestedStruct? = null

        fun build(): software.amazon.jsii.tests.calculator.RootStruct {
    ...
    class `Jsii$Proxy` : software.amazon.jsii.JsiiObject, software.amazon.jsii.tests.calculator.RootStruct {
        /**
         * May not be empty.
         */
        @get:software.amazon.jsii.Stability(software.amazon.jsii.Stability.Level.Experimental)
        ...
        @get:software.amazon.jsii.Stability(software.amazon.jsii.Stability.Level.Experimental)
        override val nestedStruct: software.amazon.jsii.tests.calculator.NestedStruct?

        protected constructor(objRef: software.amazon.jsii.JsiiObjectRef) : super(objRef) {
            this.stringProp = this.jsiiCall("stringProp", kotlin.String::class.java) ?: error("'stringProp' should be present")
            this.nestedStruct = this.jsiiCall("nestedStruct", software.amazon.jsii.tests.calculator.NestedStruct::class.java)
        }

        constructor(stringProp: kotlin.String, nestedStruct: software.amazon.jsii.tests.calculator.NestedStruct?) : super(software.amazon.jsii.JsiiObject.InitializationMode.JSII) {
        ...
        override fun equals(other: Any?): Boolean {
            ...
            other as software.amazon.jsii.tests.calculator.RootStruct
