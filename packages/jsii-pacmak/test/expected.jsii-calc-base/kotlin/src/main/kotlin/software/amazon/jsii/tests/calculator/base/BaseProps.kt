...
interface BaseProps : software.amazon.jsii.JsiiSerializable, software.amazon.jsii.tests.calculator.baseofbase.VeryBaseProps {
    ...
    class Builder {
        ...
        fun build(): software.amazon.jsii.tests.calculator.base.BaseProps {
    ...
    class `Jsii$Proxy` : software.amazon.jsii.JsiiObject, software.amazon.jsii.tests.calculator.base.BaseProps {
        ...
        constructor(foo: software.amazon.jsii.tests.calculator.baseofbase.Very, bar: kotlin.String) : super(software.amazon.jsii.JsiiObject.InitializationMode.JSII) {
            this.foo = foo
            this.bar = bar
        }
        ...
        override fun equals(other: Any?): Boolean {
            ...
            other as software.amazon.jsii.tests.calculator.base.BaseProps
