...
interface Greetee : software.amazon.jsii.JsiiSerializable {
    ...
    class Builder {
        ...
        fun build(): software.amazon.jsii.tests.calculator.Greetee {
            val name = this.name
            return `Jsii$Proxy`(name)
        }
    }

    class `Jsii$Proxy` : software.amazon.jsii.JsiiObject, software.amazon.jsii.tests.calculator.Greetee {
        /**
         * The name of the greetee.
         * 
         * Default: world
        ...
        override fun equals(other: Any?): Boolean {
            ...
            other as software.amazon.jsii.tests.calculator.Greetee
