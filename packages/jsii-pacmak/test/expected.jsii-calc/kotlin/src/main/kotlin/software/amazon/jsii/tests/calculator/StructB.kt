...
interface StructB : software.amazon.jsii.JsiiSerializable {
    ...
    @get:software.amazon.jsii.Stability(software.amazon.jsii.Stability.Level.Experimental)
    val optionalStructA: software.amazon.jsii.tests.calculator.StructA?
    ...
    class Builder {
        ...
        @get:software.amazon.jsii.Stability(software.amazon.jsii.Stability.Level.Experimental)
        var optionalStructA: software.amazon.jsii.tests.calculator.StructA? = null

        fun build(): software.amazon.jsii.tests.calculator.StructB {
    ...
    class `Jsii$Proxy` : software.amazon.jsii.JsiiObject, software.amazon.jsii.tests.calculator.StructB {
        @get:software.amazon.jsii.Stability(software.amazon.jsii.Stability.Level.Experimental)
        ...
        @get:software.amazon.jsii.Stability(software.amazon.jsii.Stability.Level.Experimental)
        override val optionalStructA: software.amazon.jsii.tests.calculator.StructA?
        ...
        protected constructor(objRef: software.amazon.jsii.JsiiObjectRef) : super(objRef) {
            ...
            this.optionalStructA = this.jsiiCall("optionalStructA", software.amazon.jsii.tests.calculator.StructA::class.java)
        }

        constructor(requiredString: kotlin.String, optionalBoolean: kotlin.Boolean?, optionalStructA: software.amazon.jsii.tests.calculator.StructA?) : super(software.amazon.jsii.JsiiObject.InitializationMode.JSII) {
        ...
        override fun equals(other: Any?): Boolean {
            ...
            other as software.amazon.jsii.tests.calculator.StructB
