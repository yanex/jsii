...
open class AllTypes : software.amazon.jsii.JsiiObject {
    ...
    @get:software.amazon.jsii.Stability(software.amazon.jsii.Stability.Level.Experimental)
    open var enumProperty: software.amazon.jsii.tests.calculator.AllTypesEnum
        get() {
            return this.jsiiGet("enumProperty", software.amazon.jsii.tests.calculator.AllTypesEnum::class.java) ?: error("'enumProperty' should be present")
        }
        set(v) {
    ...
    @get:software.amazon.jsii.Stability(software.amazon.jsii.Stability.Level.Experimental)
    open var mapProperty: kotlin.collections.Map<kotlin.String, software.amazon.jsii.tests.calculator.lib.Number>
        get() {
            return this.jsiiGet("mapProperty", kotlin.collections.Map::class.java) as? kotlin.collections.Map<kotlin.String, software.amazon.jsii.tests.calculator.lib.Number> ?: error("'mapProperty' should be present")
        }
        set(v) {
    ...
    @get:software.amazon.jsii.Stability(software.amazon.jsii.Stability.Level.Experimental)
    open var optionalEnumValue: software.amazon.jsii.tests.calculator.StringEnum?
        get() {
            return this.jsiiGet("optionalEnumValue", software.amazon.jsii.tests.calculator.StringEnum::class.java)
        }
        set(v) {
    ...
    @software.amazon.jsii.Stability(software.amazon.jsii.Stability.Level.Experimental)
    open fun enumMethod(value: software.amazon.jsii.tests.calculator.StringEnum): software.amazon.jsii.tests.calculator.StringEnum {
        val args: kotlin.Array<kotlin.Any?> = kotlin.arrayOf(
            value
        )
        return this.jsiiCall("enumMethod", software.amazon.jsii.tests.calculator.StringEnum::class.java, args) ?: error("Method 'enumMethod()' returned null value")
    }
}
