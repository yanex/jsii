...
class JsiiObject {
  ...
  public readonly staticGet = `${this.type}.jsiiStaticGet`
  public readonly staticCall = `${this.type}.jsiiStaticCall`
...
class Jackson {
  ...
  public readonly nodeFactory = 'com.fasterxml.jackson.databind.node.JsonNodeFactory'
...
export class JvmAbi {
  ...
  public static readonly stabilityAnnotationType = 'software.amazon.jsii.Stability'
