...
open class DisappointingCollectionSource : software.amazon.jsii.JsiiObject {
    companion object {
        ...
        val maybeList: kotlin.collections.List<kotlin.String>?
            get() {
                return software.amazon.jsii.JsiiObject.jsiiStaticCall(software.amazon.jsii.tests.calculator.DisappointingCollectionSource::class.java, "maybeList", kotlin.collections.List::class.java) as? kotlin.collections.List<kotlin.String>?
            }
        ...
        val maybeMap: kotlin.collections.Map<kotlin.String, kotlin.Number>?
            get() {
                return software.amazon.jsii.JsiiObject.jsiiStaticCall(software.amazon.jsii.tests.calculator.DisappointingCollectionSource::class.java, "maybeMap", kotlin.collections.Map::class.java) as? kotlin.collections.Map<kotlin.String, kotlin.Number>?
            }
