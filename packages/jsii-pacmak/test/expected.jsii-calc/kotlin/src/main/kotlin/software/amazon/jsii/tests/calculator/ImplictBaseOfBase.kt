...
interface ImplictBaseOfBase : software.amazon.jsii.JsiiSerializable, software.amazon.jsii.tests.calculator.base.BaseProps {
    @get:software.amazon.jsii.Stability(software.amazon.jsii.Stability.Level.Experimental)
    val goo: java.time.Instant

    class Builder {
        @get:software.amazon.jsii.Stability(software.amazon.jsii.Stability.Level.Experimental)
        var foo: software.amazon.jsii.tests.calculator.baseofbase.Very? = null
        ...
        fun build(): software.amazon.jsii.tests.calculator.ImplictBaseOfBase {
    ...
    class `Jsii$Proxy` : software.amazon.jsii.JsiiObject, software.amazon.jsii.tests.calculator.ImplictBaseOfBase {
        @get:software.amazon.jsii.Stability(software.amazon.jsii.Stability.Level.Experimental)
        override val foo: software.amazon.jsii.tests.calculator.baseofbase.Very
        ...
        protected constructor(objRef: software.amazon.jsii.JsiiObjectRef) : super(objRef) {
            this.foo = this.jsiiCall("foo", software.amazon.jsii.tests.calculator.baseofbase.Very::class.java) ?: error("'foo' should be present")
        ...
        constructor(foo: software.amazon.jsii.tests.calculator.baseofbase.Very, bar: kotlin.String, goo: java.time.Instant) : super(software.amazon.jsii.JsiiObject.InitializationMode.JSII) {
            this.foo = foo
            this.bar = bar
            this.goo = goo
        }
        ...
        override fun equals(other: Any?): Boolean {
            ...
            other as software.amazon.jsii.tests.calculator.ImplictBaseOfBase
