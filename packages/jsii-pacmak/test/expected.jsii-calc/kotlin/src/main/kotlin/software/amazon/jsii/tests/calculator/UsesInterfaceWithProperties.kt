...
open class UsesInterfaceWithProperties : software.amazon.jsii.JsiiObject {
    ...
    constructor(obj: software.amazon.jsii.tests.calculator.IInterfaceWithProperties) : super(software.amazon.jsii.JsiiObject.InitializationMode.JSII) {
    ...
    open val obj: software.amazon.jsii.tests.calculator.IInterfaceWithProperties
        get() {
            return this.jsiiGet("obj", software.amazon.jsii.tests.calculator.IInterfaceWithProperties::class.java) ?: error("'obj' should be present")
        }
    ...
    @software.amazon.jsii.Stability(software.amazon.jsii.Stability.Level.Experimental)
    open fun readStringAndNumber(ext: software.amazon.jsii.tests.calculator.IInterfaceWithPropertiesExtension): kotlin.String {
        val args: kotlin.Array<kotlin.Any?> = kotlin.arrayOf(
            ext
        )
