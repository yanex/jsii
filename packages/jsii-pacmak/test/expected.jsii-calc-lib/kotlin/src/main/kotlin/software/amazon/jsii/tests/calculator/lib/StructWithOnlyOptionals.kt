...
interface StructWithOnlyOptionals : software.amazon.jsii.JsiiSerializable {
    ...
    class Builder {
        ...
        fun build(): software.amazon.jsii.tests.calculator.lib.StructWithOnlyOptionals {
    ...
    class `Jsii$Proxy` : software.amazon.jsii.JsiiObject, software.amazon.jsii.tests.calculator.lib.StructWithOnlyOptionals {
        /**
         * The first optional!
         */
        @Deprecated("Declaration is deprecated.")
        ...
        override fun equals(other: Any?): Boolean {
            ...
            other as software.amazon.jsii.tests.calculator.lib.StructWithOnlyOptionals
