...
interface SmellyStruct : software.amazon.jsii.JsiiSerializable {
    ...
    class Builder {
        ...
        fun build(): software.amazon.jsii.tests.calculator.SmellyStruct {
    ...
    class `Jsii$Proxy` : software.amazon.jsii.JsiiObject, software.amazon.jsii.tests.calculator.SmellyStruct {
        @get:software.amazon.jsii.Stability(software.amazon.jsii.Stability.Level.Experimental)
        ...
        override fun equals(other: Any?): Boolean {
            ...
            other as software.amazon.jsii.tests.calculator.SmellyStruct
