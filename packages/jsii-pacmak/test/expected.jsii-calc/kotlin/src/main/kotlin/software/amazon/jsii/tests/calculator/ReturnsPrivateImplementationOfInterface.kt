...
open class ReturnsPrivateImplementationOfInterface : software.amazon.jsii.JsiiObject {
    ...
    open val privateImplementation: software.amazon.jsii.tests.calculator.IPrivatelyImplemented
        get() {
            return this.jsiiGet("privateImplementation", software.amazon.jsii.tests.calculator.IPrivatelyImplemented::class.java) ?: error("'privateImplementation' should be present")
        }
