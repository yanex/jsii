...
interface LoadBalancedFargateServiceProps : software.amazon.jsii.JsiiSerializable {
    ...
    class Builder {
        ...
        fun build(): software.amazon.jsii.tests.calculator.LoadBalancedFargateServiceProps {
    ...
    class `Jsii$Proxy` : software.amazon.jsii.JsiiObject, software.amazon.jsii.tests.calculator.LoadBalancedFargateServiceProps {
        /**
         * The container port of the application load balancer attached to your Fargate service.
         * 
         * Corresponds to container port mapping.
        ...
        override fun equals(other: Any?): Boolean {
            ...
            other as software.amazon.jsii.tests.calculator.LoadBalancedFargateServiceProps
