...
open class ConstructorPassesThisOut : software.amazon.jsii.JsiiObject {
    ...
    constructor(consumer: software.amazon.jsii.tests.calculator.PartiallyInitializedThisConsumer) : super(software.amazon.jsii.JsiiObject.InitializationMode.JSII) {
