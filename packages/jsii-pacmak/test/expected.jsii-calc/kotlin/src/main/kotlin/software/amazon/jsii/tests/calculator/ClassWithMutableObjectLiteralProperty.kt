...
open class ClassWithMutableObjectLiteralProperty : software.amazon.jsii.JsiiObject {
    ...
    open var mutableObject: software.amazon.jsii.tests.calculator.IMutableObjectLiteral
        get() {
            return this.jsiiGet("mutableObject", software.amazon.jsii.tests.calculator.IMutableObjectLiteral::class.java) ?: error("'mutableObject' should be present")
        }
        set(v) {
