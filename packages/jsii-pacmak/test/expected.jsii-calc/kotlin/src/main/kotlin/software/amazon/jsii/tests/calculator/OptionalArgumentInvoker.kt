...
open class OptionalArgumentInvoker : software.amazon.jsii.JsiiObject {
    ...
    constructor(delegateValue: software.amazon.jsii.tests.calculator.IInterfaceWithOptionalMethodArguments) : super(software.amazon.jsii.JsiiObject.InitializationMode.JSII) {
