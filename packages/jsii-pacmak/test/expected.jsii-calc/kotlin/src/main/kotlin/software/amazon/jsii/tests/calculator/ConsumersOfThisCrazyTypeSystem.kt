...
open class ConsumersOfThisCrazyTypeSystem : software.amazon.jsii.JsiiObject {
    ...
    @software.amazon.jsii.Stability(software.amazon.jsii.Stability.Level.Experimental)
    open fun consumeAnotherPublicInterface(obj: software.amazon.jsii.tests.calculator.IAnotherPublicInterface): kotlin.String {
    ...
    @software.amazon.jsii.Stability(software.amazon.jsii.Stability.Level.Experimental)
    open fun consumeNonInternalInterface(obj: software.amazon.jsii.tests.calculator.INonInternalInterface): kotlin.Any {
        val args: kotlin.Array<kotlin.Any?> = kotlin.arrayOf(
            obj
        )
